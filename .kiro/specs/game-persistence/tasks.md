...
### 10. 回放数据 API
- [x] 10.1 实现 `GET /api/games/:id` 端点
- [x] 10.2 实现 `GET /api/games/:id/replay` 端点
- [x] 10.3 优化回放数据格式

### 11. 回放控制器
- [x] 11.1 创建回放控制器 `public/js/replay.js`
- [x] 11.2 实现播放/暂停功能
- [x] 11.3 实现上一步/下一步功能
- [x] 11.4 实现进度条拖动
- [x] 11.5 实现速度控制（0.5x, 1x, 2x, 4x）

### 12. 回放页面
- [x] 12.1 创建回放页面 HTML `public/replay.html`
- [x] 12.2 集成 3D 棋盘渲染
- [x] 12.3 实现回放控制界面
- [x] 12.4 实现步数和玩家信息显示
- [x] 12.5 添加返回历史页面功能
...
### 17. 数据维护
- [x] 17.1 实现数据库备份功能
- [x] 17.2 添加定时备份任务（node-cron）
- [x] 17.3 实现过期数据清理
- [x] 17.4 添加数据库 VACUUM 优化
